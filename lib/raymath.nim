...
proc Vector2MultiplyV*(v1: Vector2; v2: Vector2): Vector2 {.RMDEF, importc: "Vector2MultiplyV".} 
# Negate vector
proc Vector2Negate*(v: Vector2): Vector2 {.RMDEF, importc: "Vector2Negate".} 
# Divide vector by a float value
proc Vector2Divide*(v: Vector2; divx: float32): Vector2 {.RMDEF, importc: "Vector2Divide".} 
# Divide vector by vector
proc Vector2DivideV*(v1: Vector2; v2: Vector2): Vector2 {.RMDEF, importc: "Vector2DivideV".} 
...
# Divide vector by a float value
proc Vector3Divide*(v: Vector3; divx: float32): Vector3 {.RMDEF, importc: "Vector3Divide".} 
# Divide vector by vector
proc Vector3DivideV*(v1: Vector3; v2: Vector3): Vector3 {.RMDEF, importc: "Vector3DivideV".} 
# Normalize provided vector
