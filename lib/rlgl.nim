...
# Defines and Macros
# ----------------------------------------------------------------------------------
template MAX_MATRIX_STACK_SIZE*(): auto = 32
template MAX_DRAWCALL_REGISTERED*(): auto = 256
# Shader and material limits
template MAX_SHADER_LOCATIONS*(): auto = 32
template MAX_MATERIAL_MAPS*(): auto = 12
